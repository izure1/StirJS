...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = emit;\n\nvar _StirEvent = __webpack_require__(/*! ../StirEvent.js */ \"./src/Stir/StirEvent.js\");\n\nvar _StirEvent2 = _interopRequireDefault(_StirEvent);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction emit(e) {\n  var o = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n\n\n  var t = void 0;\n  this.each(function () {\n    var _iteratorNormalCompletion = true;\n    var _didIteratorError = false;\n    var _iteratorError = undefined;\n\n    try {\n\n      for (var _iterator = this.__system__.events[e][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n        var f = _step.value;\n\n        t = new _StirEvent2.default(e, this).attachProperties(o);\n        f.call(this, t);\n      }\n    } catch (err) {\n      _didIteratorError = true;\n      _iteratorError = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion && _iterator.return) {\n          _iterator.return();\n        }\n      } finally {\n        if (_didIteratorError) {\n          throw _iteratorError;\n        }\n      }\n    }\n  });\n\n  return this;\n};\n\n//# sourceURL=webpack:///./src/Stir/Object/emit.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = off;\n\nvar _array = __webpack_require__(/*! ../Utils/array.js */ \"./src/Stir/Utils/array.js\");\n\nfunction off(e) {\n  var h = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;\n\n\n  var t = void 0;\n  this.each(function () {\n\n    t = this.__system__.events;\n\n    if (!(e in t)) {\n      return;\n    }\n\n    if (h === null) t[e] = [];else {\n      (0, _array.removeArrayItem)(t[e], h);\n    }\n  });\n\n  return this;\n};\n\n//# sourceURL=webpack:///./src/Stir/Object/off.js?");

/***/ }),

/***/ "./src/Stir/Object/on.js":
/*!*******************************!*\
  !*** ./src/Stir/Object/on.js ***!
  \*******************************/
/*! no static exports found */
...
/***/ "./src/Stir/Object/var/DEFAULT_EVENT.js":
/*!**********************************************!*\
  !*** ./src/Stir/Object/var/DEFAULT_EVENT.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar StirEvent = function StirEvent(e) {\n  var target = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;\n\n  _classCallCheck(this, StirEvent);\n\n  this.type = e;\n  this.target = target;\n};\n\nStirEvent.prototype.attachProperties = function () {\n  var o = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n\n\n  if (o instanceof MouseEvent) e.originalEvent = o;else {\n    Object.assign(this, o);\n  }\n\n  return this;\n};\n\nexports.default = StirEvent;\n\n//# sourceURL=webpack:///./src/Stir/StirEvent.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _DeltaTimer = __webpack_require__(/*! ./Renderer/DeltaTimer.js */ \"./src/Stir/World/Renderer/DeltaTimer.js\");\n\nvar _DeltaTimer2 = _interopRequireDefault(_DeltaTimer);\n\nvar _setUpdate = __webpack_require__(/*! ./Renderer/setUpdate.js */ \"./src/Stir/World/Renderer/setUpdate.js\");\n\nvar _setUpdate2 = _interopRequireDefault(_setUpdate);\n\nvar _run = __webpack_require__(/*! ./Renderer/run.js */ \"./src/Stir/World/Renderer/run.js\");\n\nvar _run2 = _interopRequireDefault(_run);\n\nvar _updateAnimate = __webpack_require__(/*! ./Renderer/updateAnimate.js */ \"./src/Stir/World/Renderer/updateAnimate.js\");\n\nvar _updateAnimate2 = _interopRequireDefault(_updateAnimate);\n\nvar _updateView = __webpack_require__(/*! ./Renderer/updateView.js */ \"./src/Stir/World/Renderer/updateView.js\");\n\nvar _updateView2 = _interopRequireDefault(_updateView);\n\nvar _play = __webpack_require__(/*! ./Renderer/play.js */ \"./src/Stir/World/Renderer/play.js\");\n\nvar _play2 = _interopRequireDefault(_play);\n\nvar _pause = __webpack_require__(/*! ./Renderer/pause.js */ \"./src/Stir/World/Renderer/pause.js\");\n\nvar _pause2 = _interopRequireDefault(_pause);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction Renderer() {\n  var o = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n\n\n  this.gl = null;\n  this.world = null;\n  this.f = null;\n  this.paused = false;\n  this.deltaTimer = new _DeltaTimer2.default();\n}\n\nRenderer.prototype.setUpdate = _setUpdate2.default;\nRenderer.prototype.run = _run2.default;\nRenderer.prototype.updateAnimate = _updateAnimate2.default;\nRenderer.prototype.updateView = _updateView2.default;\nRenderer.prototype.play = _play2.default;\nRenderer.prototype.pause = _pause2.default;\n\nexports.default = Renderer;\n\n//# sourceURL=webpack:///./src/Stir/World/Renderer.js?");

/***/ }),

/***/ "./src/Stir/World/Renderer/DeltaTimer.js":
/*!***********************************************!*\
  !*** ./src/Stir/World/Renderer/DeltaTimer.js ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = pause;\nfunction pause() {\n\n  if (!this.gl) {\n    throw 'You must be execute render function first.';\n  }\n\n  this.paused = true;\n};\n\n//# sourceURL=webpack:///./src/Stir/World/Renderer/pause.js?");

/***/ }),

/***/ "./src/Stir/World/Renderer/play.js":
/*!*****************************************!*\
  !*** ./src/Stir/World/Renderer/play.js ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = play;\nfunction play() {\n\n  if (!this.gl) {\n    throw 'You must be execute render function first.';\n  }\n\n  if (!this.paused) {\n    return;\n  }\n\n  this.paused = false;\n  this.run();\n};\n\n//# sourceURL=webpack:///./src/Stir/World/Renderer/play.js?");

/***/ }),

/***/ "./src/Stir/World/Renderer/run.js":
/*!****************************************!*\
  !*** ./src/Stir/World/Renderer/run.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = run;\nfunction run() {\n\n  if (this.paused) {\n    return;\n  }\n\n  // update timer\n  this.deltaTimer.update();\n\n  // run user custom function\n  this.f();\n  this.updateAnimate();\n  this.updateView();\n\n  // repeat tick\n  window.requestAnimationFrame(this.run.bind(this));\n};\n\n//# sourceURL=webpack:///./src/Stir/World/Renderer/run.js?");

/***/ }),

/***/ "./src/Stir/World/Renderer/setUpdate.js":
/*!**********************************************!*\
  !*** ./src/Stir/World/Renderer/setUpdate.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = setUpdate;\nfunction setUpdate(f) {\n\n  this.f = f.bind(this);\n};\n\n//# sourceURL=webpack:///./src/Stir/World/Renderer/setUpdate.js?");

/***/ }),

/***/ "./src/Stir/World/Renderer/updateAnimate.js":
/*!**************************************************!*\
  !*** ./src/Stir/World/Renderer/updateAnimate.js ***!
  \**************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = updateAnimate;\nfunction updateAnimate() {};\n\n//# sourceURL=webpack:///./src/Stir/World/Renderer/updateAnimate.js?");

/***/ }),

/***/ "./src/Stir/World/Renderer/updateView.js":
/*!***********************************************!*\
  !*** ./src/Stir/World/Renderer/updateView.js ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = updateView;\nfunction updateView() {};\n\n//# sourceURL=webpack:///./src/Stir/World/Renderer/updateView.js?");

/***/ }),

/***/ "./src/Stir/World/exportObjects.js":
/*!*****************************************!*\
  !*** ./src/Stir/World/exportObjects.js ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = exportObjects;\nfunction exportObjects() {\n\n  var r = void 0;\n  var j = void 0;\n\n  r = [];\n  var _iteratorNormalCompletion = true;\n  var _didIteratorError = false;\n  var _iteratorError = undefined;\n\n  try {\n    for (var _iterator = this.objects.values()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n      var v = _step.value;\n\n\n      j = {};\n      j.name = v.name;\n      j.__system__ = v.__system__;\n      j = Object.assign(j, v);\n\n      r.push(j);\n    }\n  } catch (err) {\n    _didIteratorError = true;\n    _iteratorError = err;\n  } finally {\n    try {\n      if (!_iteratorNormalCompletion && _iterator.return) {\n        _iterator.return();\n      }\n    } finally {\n      if (_didIteratorError) {\n        throw _iteratorError;\n      }\n    }\n  }\n\n  return JSON.stringify(r);\n};\n\n//# sourceURL=webpack:///./src/Stir/World/exportObjects.js?");

/***/ }),

/***/ "./src/Stir/World/importObjects.js":
/*!*****************************************!*\
  !*** ./src/Stir/World/importObjects.js ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = importObjects;\nfunction importObjects(s) {\n  var _this = this;\n\n  var t = void 0,\n      f = void 0;\n\n  s = JSON.parse(s);\n  f = function f(u) {\n    return _this.manager.getObjects(u);\n  };\n\n  registRecursiver(ns, f, this);\n\n  var _iteratorNormalCompletion = true;\n  var _didIteratorError = false;\n  var _iteratorError = undefined;\n\n  try {\n    for (var _iterator = s[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n      var o = _step.value;\n\n\n      t = f(o.name).create({\n        type: o.type\n      }).attr(o);\n\n      t.__system__ = o.__system__;\n    }\n  } catch (err) {\n    _didIteratorError = true;\n    _iteratorError = err;\n  } finally {\n    try {\n      if (!_iteratorNormalCompletion && _iterator.return) {\n        _iterator.return();\n      }\n    } finally {\n      if (_didIteratorError) {\n        throw _iteratorError;\n      }\n    }\n  }\n};\n\n//# sourceURL=webpack:///./src/Stir/World/importObjects.js?");

/***/ }),

/***/ "./src/Stir/World/pause.js":
/*!*********************************!*\
  !*** ./src/Stir/World/pause.js ***!
  \*********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = pause;\nfunction pause() {\n\n  this.renderer.pause();\n};\n\n//# sourceURL=webpack:///./src/Stir/World/pause.js?");

/***/ }),

/***/ "./src/Stir/World/play.js":
/*!********************************!*\
  !*** ./src/Stir/World/play.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = play;\nfunction play() {\n\n  this.renderer.play();\n};\n\n//# sourceURL=webpack:///./src/Stir/World/play.js?");

/***/ }),

/***/ "./src/Stir/World/render.js":
/*!**********************************!*\
  !*** ./src/Stir/World/render.js ***!
  \**********************************/
/*! no static exports found */
...
/***/ 0:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./src/Stir/Core.js ./src/Stir/Object/addClass.js ./src/Stir/Object/attr.js ./src/Stir/Object/create.js ./src/Stir/Object/css.js ./src/Stir/Object/each.js ./src/Stir/Object/emit.js ./src/Stir/Object/findClass.js ./src/Stir/Object/get.js ./src/Stir/Object/hasClass.js ./src/Stir/Object/notClass.js ./src/Stir/Object/off.js ./src/Stir/Object/on.js ./src/Stir/Object/removeClass.js ./src/Stir/Object/toggleClass.js ./src/Stir/Object/var/DEFAULT_ATTRIBUTE.js ./src/Stir/Object/var/DEFAULT_EVENT.js ./src/Stir/Object/var/DEFAULT_STYLE.js ./src/Stir/Object/var/getPropertiesProxy.js ./src/Stir/Object/var/INIT_ATTRIBUTE.js ./src/Stir/Object/var/INIT_STYLE.js ./src/Stir/Object/var/proxyHandler.attribute.js ./src/Stir/Object/var/proxyHandler.style.js ./src/Stir/Object/var/Type.js ./src/Stir/StirEvent.js ./src/Stir/StirObject.js ./src/Stir/StirObjectSession.js ./src/Stir/Utils/animate.js ./src/Stir/Utils/arguments.js ./src/Stir/Utils/array.js ./src/Stir/Utils/context.js ./src/Stir/Utils/CreateUUID.js ./src/Stir/World.js ./src/Stir/World/exportObjects.js ./src/Stir/World/importObjects.js ./src/Stir/World/Manager.js ./src/Stir/World/pause.js ./src/Stir/World/play.js ./src/Stir/World/render.js ./src/Stir/World/Renderer.js ./src/Stir/World/Renderer/DeltaTimer.js ./src/Stir/World/Renderer/pause.js ./src/Stir/World/Renderer/play.js ./src/Stir/World/Renderer/run.js ./src/Stir/World/Renderer/setUpdate.js ./src/Stir/World/Renderer/Shader.js ./src/Stir/World/Renderer/updateAnimate.js ./src/Stir/World/Renderer/updateView.js ./src/Stir/World/world.js ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! ./src/Stir/Core.js */\"./src/Stir/Core.js\");\n__webpack_require__(/*! ./src/Stir/Object/addClass.js */\"./src/Stir/Object/addClass.js\");\n__webpack_require__(/*! ./src/Stir/Object/attr.js */\"./src/Stir/Object/attr.js\");\n__webpack_require__(/*! ./src/Stir/Object/create.js */\"./src/Stir/Object/create.js\");\n__webpack_require__(/*! ./src/Stir/Object/css.js */\"./src/Stir/Object/css.js\");\n__webpack_require__(/*! ./src/Stir/Object/each.js */\"./src/Stir/Object/each.js\");\n__webpack_require__(/*! ./src/Stir/Object/emit.js */\"./src/Stir/Object/emit.js\");\n__webpack_require__(/*! ./src/Stir/Object/findClass.js */\"./src/Stir/Object/findClass.js\");\n__webpack_require__(/*! ./src/Stir/Object/get.js */\"./src/Stir/Object/get.js\");\n__webpack_require__(/*! ./src/Stir/Object/hasClass.js */\"./src/Stir/Object/hasClass.js\");\n__webpack_require__(/*! ./src/Stir/Object/notClass.js */\"./src/Stir/Object/notClass.js\");\n__webpack_require__(/*! ./src/Stir/Object/off.js */\"./src/Stir/Object/off.js\");\n__webpack_require__(/*! ./src/Stir/Object/on.js */\"./src/Stir/Object/on.js\");\n__webpack_require__(/*! ./src/Stir/Object/removeClass.js */\"./src/Stir/Object/removeClass.js\");\n__webpack_require__(/*! ./src/Stir/Object/toggleClass.js */\"./src/Stir/Object/toggleClass.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/DEFAULT_ATTRIBUTE.js */\"./src/Stir/Object/var/DEFAULT_ATTRIBUTE.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/DEFAULT_EVENT.js */\"./src/Stir/Object/var/DEFAULT_EVENT.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/DEFAULT_STYLE.js */\"./src/Stir/Object/var/DEFAULT_STYLE.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/getPropertiesProxy.js */\"./src/Stir/Object/var/getPropertiesProxy.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/INIT_ATTRIBUTE.js */\"./src/Stir/Object/var/INIT_ATTRIBUTE.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/INIT_STYLE.js */\"./src/Stir/Object/var/INIT_STYLE.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/proxyHandler.attribute.js */\"./src/Stir/Object/var/proxyHandler.attribute.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/proxyHandler.style.js */\"./src/Stir/Object/var/proxyHandler.style.js\");\n__webpack_require__(/*! ./src/Stir/Object/var/Type.js */\"./src/Stir/Object/var/Type.js\");\n__webpack_require__(/*! ./src/Stir/StirEvent.js */\"./src/Stir/StirEvent.js\");\n__webpack_require__(/*! ./src/Stir/StirObject.js */\"./src/Stir/StirObject.js\");\n__webpack_require__(/*! ./src/Stir/StirObjectSession.js */\"./src/Stir/StirObjectSession.js\");\n__webpack_require__(/*! ./src/Stir/Utils/animate.js */\"./src/Stir/Utils/animate.js\");\n__webpack_require__(/*! ./src/Stir/Utils/arguments.js */\"./src/Stir/Utils/arguments.js\");\n__webpack_require__(/*! ./src/Stir/Utils/array.js */\"./src/Stir/Utils/array.js\");\n__webpack_require__(/*! ./src/Stir/Utils/context.js */\"./src/Stir/Utils/context.js\");\n__webpack_require__(/*! ./src/Stir/Utils/CreateUUID.js */\"./src/Stir/Utils/CreateUUID.js\");\n__webpack_require__(/*! ./src/Stir/World.js */\"./src/Stir/World.js\");\n__webpack_require__(/*! ./src/Stir/World/exportObjects.js */\"./src/Stir/World/exportObjects.js\");\n__webpack_require__(/*! ./src/Stir/World/importObjects.js */\"./src/Stir/World/importObjects.js\");\n__webpack_require__(/*! ./src/Stir/World/Manager.js */\"./src/Stir/World/Manager.js\");\n__webpack_require__(/*! ./src/Stir/World/pause.js */\"./src/Stir/World/pause.js\");\n__webpack_require__(/*! ./src/Stir/World/play.js */\"./src/Stir/World/play.js\");\n__webpack_require__(/*! ./src/Stir/World/render.js */\"./src/Stir/World/render.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer.js */\"./src/Stir/World/Renderer.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer/DeltaTimer.js */\"./src/Stir/World/Renderer/DeltaTimer.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer/pause.js */\"./src/Stir/World/Renderer/pause.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer/play.js */\"./src/Stir/World/Renderer/play.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer/run.js */\"./src/Stir/World/Renderer/run.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer/setUpdate.js */\"./src/Stir/World/Renderer/setUpdate.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer/Shader.js */\"./src/Stir/World/Renderer/Shader.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer/updateAnimate.js */\"./src/Stir/World/Renderer/updateAnimate.js\");\n__webpack_require__(/*! ./src/Stir/World/Renderer/updateView.js */\"./src/Stir/World/Renderer/updateView.js\");\nmodule.exports = __webpack_require__(/*! ./src/Stir/World/world.js */\"./src/Stir/World/world.js\");\n\n\n//# sourceURL=webpack:///multi_./src/Stir/Core.js_./src/Stir/Object/addClass.js_./src/Stir/Object/attr.js_./src/Stir/Object/create.js_./src/Stir/Object/css.js_./src/Stir/Object/each.js_./src/Stir/Object/emit.js_./src/Stir/Object/findClass.js_./src/Stir/Object/get.js_./src/Stir/Object/hasClass.js_./src/Stir/Object/notClass.js_./src/Stir/Object/off.js_./src/Stir/Object/on.js_./src/Stir/Object/removeClass.js_./src/Stir/Object/toggleClass.js_./src/Stir/Object/var/DEFAULT_ATTRIBUTE.js_./src/Stir/Object/var/DEFAULT_EVENT.js_./src/Stir/Object/var/DEFAULT_STYLE.js_./src/Stir/Object/var/getPropertiesProxy.js_./src/Stir/Object/var/INIT_ATTRIBUTE.js_./src/Stir/Object/var/INIT_STYLE.js_./src/Stir/Object/var/proxyHandler.attribute.js_./src/Stir/Object/var/proxyHandler.style.js_./src/Stir/Object/var/Type.js_./src/Stir/StirEvent.js_./src/Stir/StirObject.js_./src/Stir/StirObjectSession.js_./src/Stir/Utils/animate.js_./src/Stir/Utils/arguments.js_./src/Stir/Utils/array.js_./src/Stir/Utils/context.js_./src/Stir/Utils/CreateUUID.js_./src/Stir/World.js_./src/Stir/World/exportObjects.js_./src/Stir/World/importObjects.js_./src/Stir/World/Manager.js_./src/Stir/World/pause.js_./src/Stir/World/play.js_./src/Stir/World/render.js_./src/Stir/World/Renderer.js_./src/Stir/World/Renderer/DeltaTimer.js_./src/Stir/World/Renderer/pause.js_./src/Stir/World/Renderer/play.js_./src/Stir/World/Renderer/run.js_./src/Stir/World/Renderer/setUpdate.js_./src/Stir/World/Renderer/Shader.js_./src/Stir/World/Renderer/updateAnimate.js_./src/Stir/World/Renderer/updateView.js_./src/Stir/World/world.js?");
